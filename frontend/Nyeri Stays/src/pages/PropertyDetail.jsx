    ...
    <div className="min-h-screen bg-white">
      ...
      {showImageModal && selectedImageIndex !== null && (
        <div className="fixed inset-0 bg-black bg-opacity-90 z-50 flex items-center justify-center">
          ...
          <button
            onClick={() => setSelectedImageIndex((selectedImageIndex - 1 + propertyData.images.length) % propertyData.images.length)}
            className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-full p-4 transition-all duration-200"
          >
          ...
          <img
            ...
            alt={`Modal ${selectedImageIndex + 1}`}
            className="max-w-full max-h-[80vh] object-contain rounded-lg shadow-lg"
          />
          <button
            onClick={() => setSelectedImageIndex((selectedImageIndex + 1) % propertyData.images.length)}
            className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-full p-4 transition-all duration-200"
          >
          ...
          <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 bg-black bg-opacity-70 text-white px-4 py-2 rounded-full text-lg">
